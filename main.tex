...
\usepackage{dsfont} % alphacsc
\usepackage{subfigure} % alphacsc
\usepackage{wrapfig} % alphacsc
\usepackage{algorithm} % alphacsc
\usepackage{algorithmic} % alphacsc
...
\input{chapters/2-groupstudy.tex}
% autoreject
