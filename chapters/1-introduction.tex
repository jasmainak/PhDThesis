...
\item \textbf{Parameter tuning:} Most algorithms, although automated, require hyperparameters to be tuned. This could be the number of trials to perform in an experiment, the number of components to select in a PCA decomposition, or the regularization parameter in inverse solvers.
...
\item \textbf{Reporting and quality control:} Automated Statistician . MNE web report
\end{itemize}
